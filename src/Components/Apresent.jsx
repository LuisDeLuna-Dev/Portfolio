    ...
    <div className="container">
      <div className={styles.apresent}>
        <div className={styles.apresentText}>
          <h1>
            Codificando experiências <span className={styles.neg}>excepcionais </span> para <span className={styles.neg}>cativar</span> e <span className={styles.neg}>encantar</span> usuários em cada interação.
          </h1>
          <p>
